...
#         return hook
    ...
    def reconstruct(self, input_data, labels, img, ca, canny_reg, ite, img_shape=(3, 213, 240), dryrun=False, eval=True, tol=None):
...
#         print(f'weights = {self.model.state_dict()["layer1.2.bn3.running_mean"]}')
        ...
        try:
            for trial in range(self.config['restarts']):
                group_fake =[]
                x_trial, labels = self._run_trial(group_fake, x[trial], input_data, ca, canny_reg, labels, dryrun=dryrun)
                # Finalize
...
#                 print(f'trial={trial}')
    ...
    def _run_trial(self, group_fake, x_trial, input_data, ca,  canny_reg, labels, dryrun=False):
