...
#             print("111")
    ...
    #def reconstruct(self, input_data, labels, img_shape=(3, 32, 32),  dryrun=False, eval=True, tol=None):
        ...
        if eval:
            self.model.eval()
#         print(f'model_weight = {self.model.state_dict()["layer1.2.bn3.running_mean"][0:5]}')
...
#             print(f'x_trial.shape = {x_trial.shape}')
#             print(f'self.model(x_trial).shape = {self.model(x_trial).shape}')
#             x_trial1 = x_trial.expand(config['restarts'], 1,  img_shape[0], img_shape[1], img_shape[2])
